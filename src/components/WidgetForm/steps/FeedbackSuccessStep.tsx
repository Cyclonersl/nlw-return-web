    ...
    <>
      ...
      <div className="flex flex-col items-center py-10 w-[304px]">
        ...
        <button
          ...
          className="py-2 px-6 mt-6 text-zinc-800 dark:text-zinc-100 bg-zinc-100 dark:bg-zinc-800 rounded-[4px] border-transparent text-sm leading-6 hover:bg-zinc-300 dark:hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-200 dark:focus:ring-offset-zinc-900 focus:ring-brand-500"
        >
          Quero enviar outro
        </button>
      </div>
